import type { CreateHandoffRequest, HandoffPacket } from "@yuvanext/contracts";

export function createSyntheticHandoffPacket(request: CreateHandoffRequest): HandoffPacket {
  return {
