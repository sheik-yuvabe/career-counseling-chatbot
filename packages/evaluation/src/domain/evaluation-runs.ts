...
function summarizeEvaluationRun(
  request: Pick<EvaluationRunRequest, "idempotencyKey" | "runType" | "gitRevision" | "environment" | "requestedAt">,
...
export function runSyntheticEvaluation(request: EvaluationRunRequest): EvaluationRunResponse {
...
export function getSyntheticEvaluationRun(runId: string): EvaluationRunResponse {
  const request: EvaluationRunRequest = {
